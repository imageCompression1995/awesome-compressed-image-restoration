...
|[Learning a Single Model With a Wide Range of Quality Factors for JPEG Image Artifacts Removal](https://arxiv.org/abs/2009.06912)  | 2020 | TIP| [link](https://github.com/VDIGPKU/QGCN) |These methods usually train a model based on one specific value or a small range of quality factors| quantization table as input for adapting to different qp, global pooling for global prior|utilization of the quantization tables as part of the training data, it has two branches in parallel—i.e., the restoration branch and the global branch｜
